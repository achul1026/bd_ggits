...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
                	...
                	<div class="search_table_width">
		        		...
		        		<div class="flex">
							...
							<div class="flex-column">
								...
								<div class="flex">
									<div class="table_small table_title table_line3">번호</div>
									<div class="table_column300 table_title table_line3">유사시설 명칭</div>
									<div class="table_column400 table_title table_line3">유사시설 주소</div>
									<div class="table_column200 table_title table_line3">규모(층수/동수)</div>
									<div class="table_column200 table_title table_line3">연면적(㎡)</div>
									<div class="table_column200 table_title table_line3">조사구분(현장/문헌)</div>
									<div class="table_column200 table_title table_line3">현장조사 일자(요일)</div>
									<div class="table_column500 table_title table_line3">문헌조사(참고문헌)</div>
								</div>
								</c:if>
							...
							<div>
								<div>
									<div class="flex">
										...
										<div class="flex-column">
											<div class="table_column1100 table_title">용도<c:out value="${status.index+1}"/></div>
											<div class="flex">
												<div class="table_small table_title table_line2">용도명칭</div>
												<div class="flex-column">
													<div class="flex">
														<div class="flex">
															<div class="flex-column">
																<div class="table_column500 table_title">상주</div>
																<div class="flex">
																	...
																	<div class="table_small table_title">도보및기타</div>
																</div>
															</div>
														</div>	
														<div class="flex">
															<div class="flex-column">
																<div class="table_column500 table_title">이용</div>
																<div class="flex">
																	<div class="table_small table_title">승용차</div>
																	<div class="table_small table_title">택시</div>
																	<div class="table_small table_title">버스</div>
									...
									<div class="row_value flex max-content">
										...
										<c:if test="${20 - (detailLength/10) > 0}">
											<c:set var="endPoint" value="${20 - (detailLength/10)}"/>
	...
	$(document).ready(function() {
   	...
   	// 용도별 교통수단 분담률 > 상근
	var meanShareRtArr5 = '<c:out value="${meanShareRtArr5}"/>';
	...
	.draw();
   	...
   	// 용도별 교통수단 분담률 > 이용
	var meanShareRtArr6 = '<c:out value="${meanShareRtArr6}"/>';
	new GITSChart(GITSChartType.DOUGHNUT).init("means_of_transportation_chart2")
    .setDataSetLabel('승용차', '택시', '버스', '전철/지하철', '도보 및 기타')
    .setDataSet({
            label: ['승용차', '택시', '버스', '전철/지하철', '도보 및 기타'],
            data:meanShareRtArr6.split(','),
            backgroundColor: ['#00BCB1', 'red',  'yellow', 'green', '#fff'],
            borderColor:'transparent'
    })
	.setLabelPadding(30)
