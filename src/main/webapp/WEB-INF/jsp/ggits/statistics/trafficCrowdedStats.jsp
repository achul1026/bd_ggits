	...
	<section class="main_section tab_set">
	    ...
	    <div class="group_btn_wrap tab_fc">
	        <div class="btn_search_wrap_left btn_search_wrap">
		        <ul>
		        	<li>
		        		<button type="button" class="tab_btn_item is-dark-btn is-darkgreen-btn" onclick="startLoading(); location.href='${pageContext.request.contextPath}/statistics/traffic/analysis/crowded/traffic_crowded_stats/list.do'">정체발생량</button>
		        	</li>
		        	<li>
		        		<button type="button" class="tab_btn_item is-dark-btn" onclick="startLoading(); location.href='${pageContext.request.contextPath}/statistics/traffic/analysis/crowded/traffic_congest_stats/list.do'">혼잡도</button>
		        	</li>
		        </ul>
	        </div>
	    </div>
		            ...
		            <div class="group2">
							...
							<div class="btn_search_wrap">
								<ul>
									...
									<li>
										검색 : <input type="text" class="input_same" placeholder="도로명을 입력해주세요." name="searchContent" id="searchContent" value="<c:out value='${searchOption.searchContent}'/>">
									</li>
								</ul>
							</div>
...
<!--                        	</div> -->
                       	<div class="chart">
		                    ...
		                    <div class="chart_title_sub"><c:out value='${avgSpd}'/>km/h</div>
		                </div>
	                </div>
	            </div>
	        </div>
