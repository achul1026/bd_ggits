	    ...
	    <div class="group_btn_wrap tab_fc">
	        <div class="btn_search_wrap_left btn_search_wrap">
	        	<ul>
	        		...
	        		<li>
	        			  <button type="button" class="tab_btn_item is-dark-btn is-darkgreen-btn" onclick="startLoading(); location.href='${pageContext.request.contextPath}/statistics/data/recode/bus_sttn_rout_info_colt/list.do'">정류장별 운행이력 정보 집계</button>
	        		</li>
	        	</ul>
	        </div>
	    </div>
		            ...
		            <div class="group2">
			            	...
			            	<div class="btn_search_wrap">
			            		<ul>
			            			...
			            			<li>
			            				정류장명 : <input type="text" class="input_same" id="searchContent" name="searchContent" placeholder="정류장명을 입력해주세요." value="<c:out value='${searchOption.searchContent}'/>">
			            			</li>
			            		</ul>
			            	</div>
		                ...
		                <c:choose>
		                	<c:when test="${fn:length(logTotalList) > 0 }">
		                		<c:forEach var="logInfo" items="${logTotalList}">
		                			<tr>
		                				<td class=""><c:out value='${logInfo.bstpNm}'/></td>
		                				<td><fmt:formatNumber value="${logInfo.busRouteRungCnt}" pattern="#,###" /></td>
		                				<td><fmt:formatNumber value="${logInfo.rideUserCnt}" pattern="#,###" /></td>
		                				<td><fmt:formatNumber value="${logInfo.trnsitUserCnt}" pattern="#,###" /></td>
		                				<td><fmt:formatNumber value="${logInfo.lndiUserCnt}" pattern="#,###" /></td>
		                				<td>
