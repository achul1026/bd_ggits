	...
	<section class="main_section tab_set">
	    ...
	    <div class="group_btn_wrap tab_fc">
	        <div class="table_btn_left">
	            ...
	            <button type="button" class="tab_btn_item is-dark-btn is-darkgreen-btn" onclick="location.href='${pageContext.request.contextPath}/statistics/data/recode/public_traffic_info_log_colt/list.do'">대중교통 정보 이력 집계</button>
	        	...
	        	<form id="searchForm" method="get">
		            <div class="group2">
						<div class="flex-center gap16">
			            	...
			            	<div class="flex-center gap16">
				                <div class="group_text3">노선번호</div>
					            <select class="selectBox">
		                ...
		                <div class="group2">
		                    ...
		                    <div class="flex-center">
		                        <div class="calendar">
                                    ...
                                    ~
                                    <input type="text" class="end_date_picker input_same mr8 ml8 input_picker" name="endDt" name="endDt" placeholder="날짜를 선택해주세요." autocomplete="off">
		                ...
		                <c:choose>
		                	<c:when test="${fn:length(logTotalList) > 0}">
		                		<c:forEach var="logInfo" items="${logTotalList}">
		                			<tr>
		                				<td class="left">${logInfo.routeNm}</td>
		                				<td>${logInfo.stStaNm} ↔ ${logInfo.edStaNm}</td>
		                				<td>${logInfo.busUserCnt}</td>
		                				<td>${logInfo.trsfrCnt}</td>
		                				<td>
