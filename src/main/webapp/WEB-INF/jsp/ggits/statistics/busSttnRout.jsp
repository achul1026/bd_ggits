	...
	<section class="main_section tab_set">
	    ...
	    <div class="group_btn_wrap tab_fc">
	        <div class="table_btn_left">
	            ...
	            <button type="button" class="tab_btn_item is-dark-btn is-darkgreen-btn" onclick="location.href='${pageContext.request.contextPath}/statistics/traffic/analysis/public/bus_sttn_rout/list.do'">정류장별 버스노선, 버스유형</button>
...
<!-- 		                </tr> -->
	            ...
	            <div class="table_chart_wrap">
					<div class="table_chart_list">
                        <div class="chart">
                            <div class="chart_title">평균 경유 대수</div>
                            <div class="chart_title_sub">40대</div>
                        </div>					
	                   	<div class="chart">
	                   		<div class="tab_box_title left mb16">버스 유형 <span>총 62건</span></div>
	                   		<div style="height:380px">
	                    		<canvas id="tab2_1_chart"></canvas>
	                   		</div>
	                   	</div>
	                   	<div class="chart">
	                   		<div class="tab_box_title left mb16">버스 노선 <span>총 15건</span></div>
	                   		<div style="height:380px">
...
<script>
	...
	.draw();
   	...
   	// tab2-2 chart
	new GITSChart(GITSChartType.DOUGHNUT).init("tab2_2_chart")
    .setDataSetLabel('3000번', '220번', '60번')
    .setDataSet({
            label: ['3000번', '220번', '60번'],
            data:[10, 10, 50],
            backgroundColor: ['#00BCB1', 'red',  'yellow'],
            borderColor:'transparent'
    })
