	...
	<section class="main_section tab_set">
	    ...
	    <div class="group_btn_wrap tab_fc">
	        <div class="table_btn_left">
	            ...
	            <button type="button" class="tab_btn_item is-dark-btn is-darkgreen-btn" onclick="location.href='${pageContext.request.contextPath}/statistics/traffic/analysis/public/bus_sttn_pasnr/list.do'">정류장별 승하차 승객</button>
	    ...
	    <div class="contents_wrap tab_area">
			<div class="">
		            ...
		            <div class="group2">
						<div class="flex-center gap16">
							...
							<div class="flex-center gap16">
								...
								<input type="text" class="input_same" name="searchContent" id="searchContent" placeholder="정류장명을 입력해주세요.">
							</div>
						</div>
	            ...
	            <table class="mt16">
	                ...
	                <thead>
		                <tr>
		                    <th scope="col" class="left">정류장</th>
		                ...
		                <c:choose>
		                	<c:when test="${fn:length(statsList) > 0 }">
		                		<c:forEach var="statsInfo" items="${statsList}">
		                			<tr>
		                				<td class="left">${statsInfo.bstpNm}</td>
		                				<td>-</td>
		                				<td>-</td>
		                				<td>${statsInfo.sumPasng}</td>
		                				<td>${statsInfo.rideUserCnt} / ${statsInfo.lndiUserCnt} / ${statsInfo.trnsitUserCnt}</td>
		                			</tr>
		                		</c:forEach>
		                	</c:when>
		                	<c:otherwise>
		                		<tr>
		                			<td colspan="5">승하차 승객 정보가 존재하지 않습니다.</td>
		                		</tr>
		                	</c:otherwise>
		                </c:choose>
<!-- 		                <tr> -->
...
<script>
	...
	function fnSearchList(){
		document.getElementById('searchForm').action= "${pageContext.request.contextPath}/statistics/traffic/analysis/public/bus_sttn_pasnr/list.do";
