							...
							<div>
								...
								<c:forEach var="timeTrfvlmResultList" items="${impactReportList.timeTrfvlmResultList}">
									<div class="row_value flex max-content">
										<div class="table_middle ${fn:contains(timeTrfvlmResultList.timeSctnNm, '~') ? 'table_txt' : 'table_title'}""><c:out value='${headerNo}'/>${timeTrfvlmResultList.timeSctnNm}</div>
										...
										<ul class="flex">
											<c:forEach var="timeTrfvlmDataList" items="${timeTrfvlmResultList.timeTrfvlmDataList}">
												...
												<li class="table_small ${fn:contains(timeTrfvlmResultList.timeSctnNm, '~') ? 'table_txt' : 'table_title'}"><c:out value='${timeTrfvlmDataList.totalCnt}'/></li>
											</c:forEach>			
										</ul>
									</div>
								</c:forEach>
