	...
	<section class="main_section tab_set">
	    ...
	    <div class="group_btn_wrap tab_fc">
	        <div class="table_btn_left">
	            <button type="button" class="tab_btn_item is-dark-btn is-darkgreen-btn" onclick="location.href='${pageContext.request.contextPath}/statistics/data/impact/reg_enty_exit_data_tnt/list.do'" >지역별 진출입 데이터 집계</button>
	            <button type="button" class="tab_btn_item is-dark-btn" onclick="location.href='${pageContext.request.contextPath}/statistics/data/impact/catg_enty_exit_data_tnt/list.do'" >유형별 진출입 데이터 집계</button>
	        </div>
	    </div>
	        	...
	        	<form>
		            <div class="group2">
						<div class="flex-center gap16">
			            	...
			            	<div class="flex-center gap16">
				                <div class="group_text3">유사시설</div>
					            <select class="selectBox">
