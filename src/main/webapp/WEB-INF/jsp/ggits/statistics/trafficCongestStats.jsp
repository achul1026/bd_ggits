	...
	<aside class="snb_container">
	    <div class="snb_wrap">
	        ...
	        <div class="side_btn">
	            ...
	            <a href="${pageContext.request.contextPath}/statistics/traffic/analysis/crowded/traffic_crowded_stats/list.do" class="on" onclick="startLoading()">혼잡도 통계</a>
	...
	<section class="main_section tab_set">
	    ...
	    <div class="group_btn_wrap tab_fc">
	        <div class="btn_search_wrap_left btn_search_wrap">
	        	<ul>
	        		<li>
	        			<button type="button" class="tab_btn_item is-dark-btn" onclick="startLoading(); location.href='${pageContext.request.contextPath}/statistics/traffic/analysis/crowded/traffic_crowded_stats/list.do'">정체발생량</button>
	        		</li>
	        		<li>
	        			<button type="button" class="tab_btn_item is-dark-btn is-darkgreen-btn" onclick="startLoading(); location.href='${pageContext.request.contextPath}/statistics/traffic/analysis/crowded/traffic_congest_stats/list.do'">혼잡도</button>
	        		</li>
	        	</ul>
	        </div>
	    </div>
	                	...
	                	<c:choose>
	                		<c:when test="${fn:length(crowdedList) > 0}">
	                			<c:forEach var="crowdedInfo" items="${crowdedList}">
	                				<tr>
	                					<td class=""><c:out value='${crowdedInfo.roadName}'/></td>
<!-- 	                					<td>-</td> -->
<!-- 	                					<td>-</td> -->
<!-- 	                					<td>-</td> -->
	                					<td>
	                						<fmt:formatNumber value="${crowdedInfo.vhclTrfvlm}" pattern="#,###"/>
	                					</td>
	                					<td><c:out value='${crowdedInfo.avgVhclSpeed}'/></td>
	                					<td><c:out value='${crowdedInfo.roadRank}'/></td>
	                				</tr>
	                			</c:forEach>
	                		</c:when>
	                		<c:otherwise>
...
<!--                        	</div> -->
<!--                        	<div class="chart"> -->
<!-- 		                    <div class="chart_title">평균 혼잡도</div> -->
<!-- 		                    <div class="chart_title_sub">76%</div> -->
<!-- 		                </div>                       	 -->
<!-- 	                </div> -->
<!-- 	            </div> -->
	        </div>
...
// 		}
	...
	function fnSearchList(){
		document.getElementById('searchForm').action= "${pageContext.request.contextPath}/statistics/traffic/analysis/crowded/traffic_congest_stats/list.do";
	...
	$(".dayOfWeek").on("click", function(){
   	...
   	// tab2-1 chart
//     new GITSChart(GITSChartType.LINE).init("tab2_1_chart")
