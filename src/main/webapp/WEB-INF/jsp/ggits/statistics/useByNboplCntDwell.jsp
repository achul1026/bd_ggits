...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
							...
							<div>
								<div>
									<div class="flex">
										...
										<div class="flex-column">
											<div class="table_column900 table_title">용도<c:out value="${status.index+1}"/></div>
											<div class="flex">
												<div class="table_small table_title table_line3">용도명칭</div>
												<div class="flex-column">
													<div class="table_column600 table_title">상주</div>
													<div class="flex">
														<div class="flex">
															<div class="flex-column">
												...
												<div class="flex-column">
													<div class="table_column200 table_title table_line7">방문</div>
													<div class="flex">
														<div class="table_small table_title">승용차</div>
														<div class="table_small table_title">택시</div>
													</div>
									...
									<div class="row_value flex max-content">
										...
										<ul class="flex">
											...
											<li class="table_small table_txt"><c:out value="${impactDetail.nboplCnt}"/></li>
											<!-- value for start -->
										</ul>
										</c:forEach>
										</c:if>
										<c:if test="${20 - (detailLength/8) > 0}">
												<c:set var="endPoint" value="${20 - (detailLength/8)}"/>
                    ...
                    <div class="table_chart_wrap">
	                    <div class="table_chart_list">
	                        ...
	                        <div class="chart">
	                        	...
	                        	<div style="height:380px">
	                        		<canvas id="avg_passenger_chart3"></canvas>
	                        	</div>
	                        </div>
	                        <div class="chart">
	                        	<div class="tab_box_title left mb16">방문</div>
	                        	<div style="height:380px">
	                        		<canvas id="avg_passenger_chart4"></canvas>
	                        	</div>
	                        </div>
	                     </div>
                     </div>
	...
	// 용도별 교통수단 분담률 > 통학
	var nboplCntArr2 = '<c:out value="${nboplCntArr2}"/>';
	new GITSChart(GITSChartType.DOUGHNUT).init("avg_passenger_chart2")
    .setDataSetLabel('승용차', '택시')
    .setDataSet({
            label: ['승용차', '택시'],
            data:nboplCntArr2.split(','),
            backgroundColor: ['#00BCB1', 'red'],
           	borderColor:'transparent'
    })
	.setLabelPadding(30)
	...
	// 용도별 교통수단 분담률 > 통학
	var nboplCntArr3 = '<c:out value="${nboplCntArr3}"/>';
	new GITSChart(GITSChartType.DOUGHNUT).init("avg_passenger_chart3")
    .setDataSetLabel('승용차', '택시')
    .setDataSet({
            label: ['승용차', '택시'],
            data:nboplCntArr3.split(','),
            backgroundColor: ['#00BCB1', 'red'],
           	borderColor:'transparent'
    })
	.setLabelPadding(30)
	...
	// 용도별 교통수단 분담률 > 통학
	var nboplCntArr4 = '<c:out value="${nboplCntArr4}"/>';
	new GITSChart(GITSChartType.DOUGHNUT).init("avg_passenger_chart4")
    .setDataSetLabel('승용차', '택시')
    .setDataSet({
            label: ['승용차', '택시'],
            data:nboplCntArr4.split(','),
            backgroundColor: ['#00BCB1', 'red'],
           	borderColor:'transparent'
    })
	.setLabelPadding(30)
