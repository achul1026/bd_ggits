	...
	<section class="main_section tab_set">
	    ...
	    <div class="group_btn_wrap tab_fc">
	        <div class="table_btn_left">
	            ...
	            <button type="button" class="tab_btn_item is-dark-btn is-darkgreen-btn" onclick="location.href='${pageContext.request.contextPath}/statistics/traffic/analysis/public/bus_sttn_facility_info/list.do'">정류장별 시설물 및 기타정보</button>
	            ...
	            <table class="mt16">
	                ...
	                <thead>
		                <tr>
		                    ...
		                    <th scope="col">시설물 등록일</th>
		                    <th scope="col">시설물 보수이력</th>
		                    <th scope="col">담당자</th>
		                </tr>
	                </thead>
	                <tbody>
	                	<c:choose>
	                		...
	                		<c:otherwise>
	                			<tr>
	                				<td colspan="6">시설물 정보가 존재하지 않습니다.</td>
	                			</tr>
	                		</c:otherwise>
	                	</c:choose>
<!-- 		                <tr> -->
