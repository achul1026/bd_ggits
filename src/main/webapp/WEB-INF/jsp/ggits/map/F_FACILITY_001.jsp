...
<div>
	...
	<div class="dashboard_node_box">
	    <div class="node_title">${paging.totalCount}개의 <span>"VDS"</span>를 찾았습니다.</div>
	    <div id="modalTbody">
		    <ul>
		    	<c:forEach var="resultList" items="${resultList}">
					<li class="node_item">
						...
						<ul>
							<li class="popup_item">VDS명 : <span>${resultList.name}</span></li>
	...
	$.ajax({
		...
		success : function(result) {
			...
			$(result.data.list).each(function(index, item){
				var detailHtml = 	'<ul>'+
										'<li class=\'popup_item\'>VDS명 : <span>'+item.name+'</span></li>'+
			...
			if(paging != null && paging != ''){
				title += paging.totalCount+'개의 <span>"VDS"</span>를 찾았습니다.';
