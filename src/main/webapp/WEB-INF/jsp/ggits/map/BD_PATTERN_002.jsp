...
<div class="tab_bigbox_close">
    <div class="original_box clearfix">
    	<form id="searchForm">
	        ...
	        <div class="tab_item_box flex-center pt8 none" id="crossroadsListDiv">
				...
				<div class="gis_table_scroll">
					<div class="flex-center gap8">
					    <input type="text" class="bigdata_list_input" id="searchCrsrdNm" placeholder="교차로명을 입력해주세요.">
	        ...
	        <div class="tab_item_box flex-center">
	            <h5 class="tab_item_title">집계기준</h5>
	            <label class="group_btn_item is-dark-btn radius inpd is-darkgreen-btn"><input type="checkbox" class="none" name="searchResultType" value="totalSum" checked="checked">누적</label>
	            <label class="group_btn_item is-dark-btn radius inpd"><input type="checkbox" class="none" name="searchResultType" value="totalAvg">평균</label>
	        </div>
        </form>
        ...
        var remarksItem =$(`
	        <div class="remarks_container">
		        <div class="remarks_title_box">
		            <h6 class="remarks_title">범례 - 누적교통량</h6>
		        </div>
	        	<div class="remarks_wrap tab-none">
	            	<div>
		                <div class="check_line_container">
		                    <button type="button" class="check_line_box remarks-red">1131 이상</button>
		                    <button type="button" class="check_line_box remarks-orange">1101 - 1130 이하</button>
		                    <button type="button" class="check_line_box remarks-light-orange">171 - 1100 이하</button>
		                    <button type="button" class="check_line_box remarks-light-green">141 - 170 이하</button>
		                    <button type="button" class="check_line_box remarks-green">0 - 140 이하</button>
		                </div>
	            	</div>
