...
<div class="tab_bigbox_close">
    <div class="original_box clearfix">
    	<form id="searchForm" class="result_change">
			...
			<input type="hidden" name="searchResultType" value="vhclTrfvlm">
...
<script>
	...
	function fnSearchList(){
		...
		$.ajax({
			...
			timeout : 60*1000*10,
			url : "${pageContext.request.contextPath}/map/bigdata/effect/analysis/BD_EFFECT_ANALYSIS_002/data.ajax",
			beforeSend : function(){
				startLoading();
			},
...
/*     	var roadRank = $("input[name='roadRank']");
		...
		var searchResultType = $("input[name='searchResultType']").val();
        ...
        window.dualMap.bigdata.getTrafficActiveEffectAnalysis(edForm); // 후
        window.map.bigdata.getTrafficActiveEffectAnalysis(stForm); // 전
...
//        	let oneHourAfterLeft = Number(endTime)+1 < 10 ? "0"+(Number(endTime)+1):Number(endTime)+1;
	        	...
	        	<div class="remarks_wrap">
	            	<div>
		                <ul class="check_line_container">
		                    <li class="check_line_box remarks-red">200,001 - </li>
		                    <li class="check_line_box remarks-orange">150,001 - 200,000</li>
		                    <li class="check_line_box remarks-light-orange">100,001 - 150,000</li>
		                    <li class="check_line_box remarks-light-green">50,001 - 100,000</li>
		                    <li class="check_line_box remarks-green">0 - 50,000</li>
		                </ul>
	            	</div>
        ...
        if(searchResultType === 'vhclTrfvlm'){
