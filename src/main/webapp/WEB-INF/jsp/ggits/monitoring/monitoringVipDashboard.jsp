    ...
    <div class="header_container">
        ...
        <div class="utility_box flex-center">
            <div class="day_weather_box flex-center">
                <div class="day_data"><c:out value="${now}"/></div>
            </div>
            <div class="email_box flex-center">
                <div class="email"><c:out value="${mOpOperator.oprtrEmail}"/></div>
            </div>
            <div class="setting">
		...
		<c:import url="/WEB-INF/jsp/ggits/common/inc_map_control.jsp"></c:import>
			<div class="moitoring_dashboard_contentbox">
				...
				<div id="svcCongestionDiv" class="mini_dash_box mini_height">
					<c:import url="/WEB-INF/jsp/ggits/monitoring/module/dashboard_svc_congestion_top10.jsp"></c:import>
				</div>
			</div>
		</div>
    </div>
...
//		svcCongestionTop10Init(true);
	    ...
	    timer = setInterval( function () {
			...
			/* 도로별 주요 정체구간 TOP 10 */
	// 		svcCongestionTop10Init(svcCongestionTop10Stts);
			/* 사고예측구간 지수 top 10 */
	...
	/* 도로별 주요 정체구간 TOP 10 */
	function svcCongestionTop10Init(svcCongestionTop10Stts){
		if(svcCongestionTop10Stts){
	        ...
	        $.ajax ({
	            type : "get",
	            url : "${pageContext.request.contextPath}/monitoring/MDM003/loadMonitoringModule.ajax",
	            cache : false,
	            dataType : "html",
	            success : function(html) {
