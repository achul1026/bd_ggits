                ...
                <form id="userSaveForm">
	                ...
	                <div class="contents_wrap">
	                    ...
	                    <div class="group">
	                        ...
	                        <input type="password" placeholder="비밀번호를 입력해 주세요." class="input_same group_box data-validate" name="oprtrPswd" onkeyup="isPwValidated(this)"
	                    ...
	                    <div class="group">
                        	...
                        	<div class="input_same group_box div_input_style" id="addngCdNm">소속 행정기관을 선택해주세요.</div>
					...
					$.ajax({
		    			...
		    			success : function(data) {
		    				...
		    				if(resultCode == '200'){
		    					...
		    					new ModalBuilder().init().alertBoby("사용자 등록을 실패하였습니다.").footer(4,'확인',function(button, modal){modal.close();}).open();
		    					modalAlertWrap();
		    				}
		    			}
		    		});					
