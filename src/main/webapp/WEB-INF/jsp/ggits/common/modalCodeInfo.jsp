	...
	<form id="codeUpdFrm">
		<div class="flex-center gap16 mt16">
			<div class="flex-column modal_input_box">
				...
				<input type="hidden" name="cdId" id="cdId" value="${mOpCode.cdId}">
				<label class="modal_input_label">코드</label>
				${mOpCode.cdId}
			</div>
			<div class="flex-column modal_input_box">
				<label class="modal_input_label">코드명</label>
				<input type="text" name="cdNm" id="cdNm" class="modal_input data-validate" placeholder="코드명을 입력해 주세요." value="${mOpCode.cdNm}"
		...
		<div class="flex-center gap16 mt16">
			<div class="flex-column modal_input_box">
				...
				<input type="text" name="descr" id="descr" class="modal_input" placeholder="코드 설명을 입력해 주세요." value="${mOpCode.descr}" maxlength="400"> 
			</div>
			<div class="flex-column modal_input_box">
				<label class="modal_input_label">순위</label>
				<input type="text" name="sortNo" id="sortNo" class="modal_input data-validate" onkeyup='chkSortNo(this)' placeholder="1~99까지의 숫자를 입력해주세요." value="${mOpCode.sortNo}"
