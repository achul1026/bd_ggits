...
<div class="" style="width:30rem;">
	<div class="flex-center gap16">
		<div class="flex-column modal_input_box">
			...
			<div class="modal_input"><c:out value='${logInfo.logId}'/></div>
		</div>
		<div class="flex-column modal_input_box">
			<label class="modal_input_label">발생 일자</label>
			<div class="modal_input"><c:out value='${logInfo.occurDtStr}'/></div> 
		</div>
	</div>
	<div class="flex-center gap16 mt16">
		<div class="flex-column modal_input_box">
			<label class="modal_input_label">로그 유형</label>
			<div class="modal_input"><c:out value='${logInfo.cdNm}'/></div> 
		</div>
		<div class="flex-column modal_input_box">
			<label class="modal_input_label">요청자 ID</label>
			<c:choose>
				<c:when test="${logType eq 'user'}">
					<div class="modal_input"><c:out value='${logInfo.prgrmSesnId}'/></div> 
				</c:when>
				<c:otherwise>
					<div class="modal_input"><c:out value='${logInfo.sesnId}'/></div> 
				</c:otherwise>
			</c:choose>
		</div>
	</div>
	<div class="flex-center gap16 mt16">
		<div class="flex-column modal_input_box">
			...
			<c:choose>
				...
				<c:otherwise>
					<div class="modal_input"><c:out value='${logInfo.rqstrNm}'/></div> 
				</c:otherwise>
			</c:choose>
		</div>
		<div class="flex-column modal_input_box">
			<label class="modal_input_label">요청자 IP</label>
			<div class="modal_input"><c:out value='${logInfo.lgnIp}'/></div> 
		</div>
	</div>
</div>