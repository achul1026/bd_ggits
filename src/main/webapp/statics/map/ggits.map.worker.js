...
self.importScripts(
    ...
    ,"./modules/bigdata/BD_Danger_Road.js"
    ...
    /*,"./modules/bigdata/BD_Public_Transfer_Usage_By_St_End.js"*/
    ,"./modules/bigdata/BD_Public_Transfer_Usage_By_SGG.js"
    ,"./modules/bigdata/BD_Public_Transfer_Duplicate_Route.js"
    ,"./modules/bigdata/BD_Public_Transfer_Cndcy_Route.js"
);
    ...
    try {
        switch (e.data.event) {
            ...
            case "BD_PT_DANGER_ANALYSIS" :
                ...
                resultData.bbox = self.util.getBBOX(resultData.busRouteFeatureCollection.featureCollection);
                break;
            case "BD_DANGER_ROAD" :
                eventName = "도로안전 정보";
