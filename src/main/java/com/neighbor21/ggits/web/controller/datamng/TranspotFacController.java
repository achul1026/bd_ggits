...
@Controller
@RequestMapping("/datamng/transpotFac")
public class TranspotFacController {
   ...
   * @작성일 : 2023. 11. 09.
   * @작성자 : KY.LEE
   * @Method 설명 : 자료관리 메뉴 -> 교통 시설물
   * @return
   */
  @GetMapping("/list.do")
  public String viewDataMngList(Model model, FileMngTotInfo fileMngTotInfo) {
    fileMngTotInfo.setFileDivCd(FiledivCd.TRANSPOT_FACILLITY.getCode());
    ...
    return "view/datamng/transpotFacList";
  }

  /**
   * @Method Name : saveFileMngTranspotFacInfo
   * @작성일 : 2023. 11. 22.
   * @작성자 : IK.MOON
   * @Method 설명 : 교통 시설물 자료 등록
   * @return
   */
  @PostMapping("/save.ajax")
  public @ResponseBody CommonResponse<?> saveFileMngTranspotFacInfo(
  ...
  /**
   * @Method Name : updateFileMngTranspotFacInfo
   * @작성일 : 2023. 11. 22.
   * @작성자 : IK.MOON
   * @Method 설명 : 교통 시설물 자료 수정
   * @return
   */
  @PostMapping("/update.ajax")
  public @ResponseBody CommonResponse<?> updateFileMngTranspotFacInfo(
      @RequestPart FileMngTotInfo fileMngTotInfo,
