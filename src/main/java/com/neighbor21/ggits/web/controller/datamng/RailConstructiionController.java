...
@Controller
@RequestMapping("/datamng/railConstruction")
public class RailConstructiionController {
   ...
   * @작성일 : 2023. 11. 09.
   * @작성자 : KY.LEE
   * @Method 설명 : 자료관리 메뉴 -> 철도관리
   * @return
   */
  @GetMapping("/list.do")
  public String viewDataMngList(Model model, FileMngTotInfo fileMngTotInfo) {
    fileMngTotInfo.setFileDivCd(FiledivCd.RAIL.getCode());
    ...
    return "view/datamng/railConstructionList";
  }
   ...
   * @작성일 : 2023. 11. 22.
   * @작성자 : IK.MOON
   * @Method 설명 : 철도관리 자료 등록
   * @return
   */
  @PostMapping("/save.ajax")
  public @ResponseBody CommonResponse<?> saveFileMngRailConstrInfo(@RequestPart FileMngTotInfo fileMngTotInfo,
   ...
   * @작성일 : 2023. 11. 22.
   * @작성자 : IK.MOON
   * @Method 설명 : 철도관리 자료 수정
   * @return
   */
  @PostMapping("/update.ajax")
  public @ResponseBody CommonResponse<?> updateFileMngRailConstrInfo(
