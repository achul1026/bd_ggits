...
@Controller
@RequestMapping("/datamng/trfInfoCenter")
public class TrfInfoCenterController {
   ...
   * @작성일 : 2023. 11. 09.
   * @작성자 : KY.LEE
   * @Method 설명 : 자료관리 메뉴 -> 교통정보센터
   * @return
   */

  @GetMapping("/list.do")
  public String viewDataMngList(Model model, FileMngTotInfo fileMngTotInfo) {
    fileMngTotInfo.setFileDivCd(FiledivCd.TRAFFIC_INFO_CENTER.getCode());
    ...
    return "view/datamng/trfInfoCenterList";
  }
   ...
   * @작성일 : 2023. 11. 20.
   * @작성자 : IK.MOON
   * @Method 설명 : 교통정보센터 자료 업로드
   * @return
   */
  @PostMapping("/save.ajax")
  public @ResponseBody CommonResponse<?> saveFileMngTrfInfoCenterInfo(
  ...
  /**
   * @Method Name : updateFileMngTrfInfoCenterInfo
   * @작성일 : 2023. 11. 22.
   * @작성자 : IK.MOON
   * @Method 설명 : 교통정보센터 자료 수정
   * @return
   */
  @PostMapping("/update.ajax")
  public @ResponseBody CommonResponse<?> updateFileMngTrfInfoCenterInfo(
      @RequestPart FileMngTotInfo fileMngTotInfo,
