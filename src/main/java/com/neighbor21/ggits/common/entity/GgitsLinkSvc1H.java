...
public class GgitsLinkSvc1H {
	private Timestamp procDate; // 소통정보가공시각
	private String linkId; // 링크 아이디
	private long spd; // 1시간 동안의 링크의 평균속도
	private long vol; // 교통량
	private long dens; // 밀도
	private long trvlTime; // 1시간 동안의 링크길이에 대한 링크평균속도를 시간으로 환산한 값
