...
//구역 인구 이동 상세 정보
public class MoisDstrctPopltnMoveDtlInfo {
  ...
  private String maleAgeCd; //남성 연령 코드
  private String femaleAgeCd; //여성 연령 코드
  ...
  public String getMaleAgeCd() {
    return maleAgeCd;
  }

  public void setMaleAgeCd(String maleAgeCd) {
    this.maleAgeCd = maleAgeCd;
  }


  public String getFemaleAgeCd() {
    return femaleAgeCd;
  }

  public void setFemaleAgeCd(String femaleAgeCd) {
    this.femaleAgeCd = femaleAgeCd;
  }
