...
public class GgbisBusStation {
	...
	private Double stLinkX;
	private Double stLinkY;
	...
	public Double getStLinkX() {
		return stLinkX;
	}

	public void setStLinkX(Double stLinkX) {
		this.stLinkX = stLinkX;
	}

	public Double getStLinkY() {
		return stLinkY;
	}

	public void setStLinkY(Double stLinkY) {
	...
	public Long getMobileNoSi() {
		return mobileNoSi;
	}

	public void setMobileNoSi(Long mobileNoSi) {
