...
//행정시 대기질 측정 정보
public class AirkrAdsiArqltMsrmtInfo {
  ...
  private String msrmtAdsiNm; //측정 행정시 명
  ...
  public String getMsrmtAdsiNm() {
    return msrmtAdsiNm;
  }

  public void setMsrmtAdsiNm(String msrmtAdsiNm) {
    this.msrmtAdsiNm = msrmtAdsiNm;
  }
