...
//	private static String padding = "123456789123456789";
	private static String padding = "230918139452";
	...
	public McashCipher(String tradeid) {
		...
		if (keyLength < 16) {
			tmpKey = String.valueOf(tmpKey) + padding.substring(0, 16 - keyLength);
		} else {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println("====================================================================");
	    System.out.println("가맹점측 결제정보 함호화 전달값");
	    System.out.println("====================================================================");
	    ...
	    System.out.println("암호화전달값체크=" + 
	        decodeString(cCryptstring, tradeid).equals(
	          String.valueOf(decodeString(cPrdtprice, tradeid)) + decodeString(cOkurl, tradeid)));
	  }
}
